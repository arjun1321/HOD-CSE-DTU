                ...
                <!-- /.row -->
                    ...
                    <?php
                            ...
                            switch($source) {
                                ...
                                case 'add_admin_activities':
                                    include "include/add_admin_activities.php";
                                    break;
                                case 'view_admin_activities':
                                    include "include/view_admin_activities.php";
                                    break;
                                    
                                case 'edit_admin_activities':
                                    include "include/edit_admin_activities.php";
                                    break;
